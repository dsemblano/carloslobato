  <section class="bg-pros90gray w-full">
      <div class="container max-w-5xl mx-auto p-4 m-8">
        ...
        <div class="w-full mb-4">
          <div class="h-1 mx-auto px-4 gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <div class="flex flex-wrap">
          ...
          <div class="w-full sm:w-1/2 p-6">
            <svg class="w-full sm:h-64 mx-auto px-4" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">

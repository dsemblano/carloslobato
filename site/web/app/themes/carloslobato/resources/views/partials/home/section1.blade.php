<section class="section1 px-3 mx-auto px-4 flex flex-wrap flex-col md:flex-row items-center bg-white border-bs container">
  <!--Left Col-->
  <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
    ...
    <p class="leading-normal text-2xl mb-8">
      section1 Advogado, radialista e jornalista, nascido em 16/11/1956 é pré candidato a Deputado Estadual pelo Pros 90 Amapá.
    </p>
    <p>
      #naocala
    </p>

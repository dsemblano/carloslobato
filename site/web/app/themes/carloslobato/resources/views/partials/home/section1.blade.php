<section id="section1" class="flex flex-col lg:flex-row lg:mt-40 justify-between items-start bg-white">
  ...
  <div class="flex flex-col w-full lg:w-2/5 justify-center text-center lg:text-left animated animatedFadeInUp fadeInUp">
    ...
    <img class="block lg:hidden rounded-tl-extraLarge rounded-br-extraLarge" width="834" height="834" alt="Imagem Carlos Lobato principal na home" src="@asset('images/Carlos Lobato foto perfil.png')" />
    <article class="mt-8 mb-8 prose lg:prose-2xl  prose-a:text-blue-800 prose-a:no-underline hover:prose-a:text-blue-500 hover:prose-a:underline">
      <p class="leading-normal text-xl mb-8">
        Candidato a Deputado Estadual pelo <a class="underline" target="_blank" href="https://pros90amapa.org.br">PROS Amapá</a>, advogado, psicólogo, sociólogo, jornalista e ex-âncora do Tribuna da Cidade na 101 FM.
      </p>
      <p class="leading-normal text-xl mb-8">
  ...
  <div class="social hidden lg:block w-full pl-48">
    <img class="z-50 hidden lg:block rounded-tl-extraLarge rounded-br-extraLarge" width="834" height="834" alt="Imagem Carlos Lobato principal na home" src="@asset('images/Carlos Lobato foto perfil.png')" />

<section id="section1">
  <div class="container px-8 lg:px-16 flex flex-col lg:flex-row lg:mt-40 justify-between items-startrelative">
    <!--Left Col-->
    <div
      ...
      <article
        ...
        <p class="leading-normal text-xl mb-8">
          ...
          aos estudos, o menino pobre, que vendeu sacolas no Mercado Central, cresceu e passou em 22 vestibulares.
          Venceu na
    ...
    <div class="social hidden lg:block w-full lg:w-3/5 pl-48 animate__animated animate__fadeInUpBig">
      <img class="clperfil z-50 hidden lg:block" width="600" height="718" alt="Imagem Carlos Lobato principal na home"
        src="@asset('images/CLperfil.png')" />
